...
const TemplateList: React.FC<ITemplateList> = ({ product, className }) => {
    ...
    return (
        <div className={`grid md:grid-cols-12 justify-items-center md:items-center gap-4 md:gap-6 py-8 border-b-2 border-gray-300 text-center md:text-start ${className}`}>
            ...
            <div className="md:col-span-3">
                <button className="rounded-full px-8 py-4 overflow-hidden relative group cursor-pointer font-medium bg-blue-500 text-blue-950">
                    ...
                    <span className="relative transition duration-300 group-hover:text-white ease text-md font-bold">Read More →</span>
                </button>
            </div>
        </div>
    );
