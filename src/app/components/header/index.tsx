    ...
    return (
        <header>
            <div className="relative">
                {/* TOP TABLET */}
                <div className="hidden md:flex flex-col lg:flex-row items-center lg:justify-around ">
                ...
                <div className={`relative ${openMenu ? 'hidden' : 'flex'} flex-row gap-4 justify-center py-4 min-h-24 `}>
                ...
                {/* MENU OPEN */}
                {openMenu &&
                    <div className="absolute bg-blue-950 min-h-screen min-w-full p-4">
