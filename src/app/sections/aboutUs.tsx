            ...
            <div className="container">
                <div className="flex flex-col xl:flex-row gap-14 items-center lg:justify-center py-4">
                    <div className="flex gap-4 justify-center items-end">
                        <Image src="/assets/images/photos/sala3.JPG" alt="imagen 1" width={230} height={318} className="hidden md:block w-full h-auto" />
                        <Image src="/assets/images/photos/delso.JPG" alt="imagen 2" width={315} height={439} className="w-full h-auto" />
                    </div>
