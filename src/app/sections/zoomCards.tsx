...
const SectionZoomCards = () => {
    return (
        <section>
            <div className="flex flex-wrap sm:flex-nowrap relative">
                {ZoomCardsData.map((zoomCard, i) => (
                    <div key={i} className="relative group w-1/2 lg:w-full h-[40rem] overflow-hidden">
                        <img src={zoomCard.image} className="absolute w-full transition-transform transform group-hover:scale-125" />
